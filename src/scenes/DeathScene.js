...
export class DeathScene extends Scene {
    ...
    create() {
        ...
        this.add.text(1024 / 2 - 70, 255, 'Chaos destroyed', FLAVOR_TEXT_CONFIG);
        this.add.text(1024 / 2 - 100, 300, 'An elemental Island!', FLAVOR_TEXT_CONFIG);
        //this.add.text(1024 / 2 - 100, 325, 'Island!.', FLAVOR_TEXT_CONFIG);
        ...
        this.add.text(
            1024 / 2 - 110,
            405,
            `Bane of chaos        +  ${character.lastBane}`,
            FLAVOR_TEXT_CONFIG
        );
        this.add.text(
            1024 / 2 - 120,
            455,
            `Boon of fortune     +  ${character.lastBoon}`,
            FLAVOR_TEXT_CONFIG
        );
